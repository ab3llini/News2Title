...
from model.embedding.encoderdecoder import encoder_decoder
...
model = encoder_decoder(latent_dim=config.latent_dim, max_encoder_seq_len=config.max_article_len,
                        ...
                        embeddings=config.embeddings, optimizer=config.optimizer,
